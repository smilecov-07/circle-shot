...
- При рисовании оружия не забывайте про принципы в `drawing.md`, а также про ещё несколько моментов:
...
- Не забывайте устанавливать `collision_layer` и `collision_mask` у детекторов для атаки.
